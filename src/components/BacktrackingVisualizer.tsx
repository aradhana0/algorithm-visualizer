...
import type { BacktrackingAlgorithm } from '../types'
...
type Props = { algorithm: BacktrackingAlgorithm }

export function BacktrackingVisualizer({ algorithm }: Props) {
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-hidden">
            {current && <NQueensViz step={current} />}
          </div>
          {current?.message && (
